      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {isEditing ? <>
              ...
              <Button size="sm" variant="outline" onClick={handleCancel} className="text-red-600 hover:text-red-700 border-red-300 hover:border-red-400 bg-gray-100 hover:bg-red-50 dark:text-red-400 dark:hover:text-red-300 dark:border-red-600 dark:hover:border-red-500 dark:bg-gray-800 dark:hover:bg-red-900/20">
                <X className="h-4 w-4" />
              </Button>
            </> : <Button size="sm" variant="outline" onClick={() => setIsEditing(true)} className="text-gray-500 hover:text-gray-700 border-gray-300 hover:border-gray-400 bg-gray-100 hover:bg-gray-200 dark:text-gray-300 dark:hover:text-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:bg-gray-800 dark:hover:bg-gray-700/50">
              <Edit2 className="h-4 w-4" />
            </Button>}
          
          <Button size="sm" variant="outline" onClick={() => onSync(calendar)} disabled={!hasValidUrl} title={hasValidUrl ? "Sync this calendar" : "No URL available for syncing"} className="text-blue-600 hover:text-blue-700 border-blue-300 hover:border-blue-400 bg-gray-100 hover:bg-blue-50 dark:text-blue-400 dark:hover:text-blue-300 dark:border-blue-600 dark:hover:border-blue-500 dark:bg-gray-800 dark:hover:bg-blue-900/20 disabled:opacity-50 disabled:cursor-not-allowed">
            <RefreshCw className={`h-4 w-4 ${syncStatus === 'syncing' ? 'animate-spin' : ''}`} />
          </Button>
          
          <Button size="sm" variant="outline" onClick={() => onRemove(calendar)} title="Remove this calendar" className="text-red-600 hover:text-red-700 border-red-300 hover:border-red-400 bg-gray-100 hover:bg-red-50 dark:text-red-400 dark:hover:text-red-300 dark:border-red-600 dark:hover:border-red-500 dark:bg-gray-800 dark:hover:bg-red-900/20">
