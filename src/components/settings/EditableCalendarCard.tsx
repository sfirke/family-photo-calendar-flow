      ...
      <div className="flex items-center justify-between p-4">
        <div className="flex items-center gap-3 flex-1">
          <div 
            ...
            style={{ backgroundColor: isEditing ? editData.color : calendar.color }} 
            ...
            {isEditing ? (
              ...
              <>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
                  ...
                  {hasValidUrl 
                    ? calendar.url.length > 50 
                      ? `${calendar.url.substring(0, 50)}...` 
                      : calendar.url 
                    : 'No URL available'
                  }
                </p>
        ...
        <div className="flex items-center gap-2">
          ...
          {isEditing ? (
            ...
            <Button 
              ...
              className="text-gray-700 hover:text-gray-900 border-gray-300 hover:border-gray-400 hover:bg-gray-50 dark:text-gray-300 dark:hover:text-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-700/50"
            >
